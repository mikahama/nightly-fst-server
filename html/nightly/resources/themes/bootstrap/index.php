...
<html>
    ...
    <head>
        ...
        <title>Wolf NLP: Free morphological FSTs for multiple languages</title>
    ...
    <body>
        ...
        <div id="page-navbar" class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <p class="navbar-text"><a href="../">Front Page</a></p>
        ...
        <div id="page-content" class="container">
            ...
            <div id="directory-list-header">
                <div class="row">
                    <div class="col-md-7 col-sm-6 col-xs-10">Language</div>
                    <div class="col-md-2 col-sm-2 col-xs-2 text-right">ISO code</div>
            ...
            <ul id="directory-listing" class="nav nav-pills nav-stacked">
                ...
                <?php foreach($dirArray as $name => $fileInfo): ?>
                    <li data-name="<?php echo $name; ?>">
                        <a href="<?php echo $name; ?>" class="clearfix" data-name="<?php echo $name; ?>">


                            <div class="row">
                                <span class="file-name col-md-7 col-sm-6 col-xs-9">
                                    <i class="fa <?php echo $fileInfo['icon_class']; ?> fa-fw"></i>
                                    <?php echo $lister->isoToName($name); ?>
                                </span>
